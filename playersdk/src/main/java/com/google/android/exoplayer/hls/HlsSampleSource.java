                                              ...
                                              Loader.Callback
{
                        ...
                        SampleHolder sampleHolder, boolean onlyReadDiscontinuity)
    {
        ...
        if (downstreamFormat == null || !downstreamFormat.equals(extractor.format))
        {
            ...
            notifyDownstreamFormatChanged(extractor.format,
                                          extractor.trigger,
    ...
    public void onLoadCompleted(Loadable loadable)
    {
        ...
        if (isTsChunk(currentLoadable))
        {
            ...
            notifyLoadCompleted(currentLoadable.bytesLoaded(),
                                currentTsLoadable.type,
                                currentTsLoadable.trigger,
                                currentTsLoadable.format,
                                currentTsLoadable.startTimeUs,
                                currentTsLoadable.endTimeUs,
                                now,
                                loadDurationMs);
        }
        else
    ...
    private void maybeStartLoading()
    {
        ...
        if (isTsChunk(currentLoadable))
        {
            ...
            notifyLoadStarted(tsChunk.dataSpec.length,
                              tsChunk.type,
                              tsChunk.trigger,
                              tsChunk.format,
                              tsChunk.startTimeUs,
    ...
    private void notifyLoadStarted(final long length,
                                   final int type,
                                   final int trigger,
                                   final Format format,
