                                                    ...
                                                    SampleSourceReader
{
    ...
    private static MediaFormat createMediaFormat(android.media.MediaFormat format)
    {
        ...
        String language = getOptionalStringV16(format,
        ...
        int width = getOptionalIntegerV16(format,
                                          android.media.MediaFormat.KEY_WIDTH);
        int height = getOptionalIntegerV16(format,
        ...
        int sampleRate = getOptionalIntegerV16(format,
        ...
        MediaFormat mediaFormat = new MediaFormat(mimeType,
