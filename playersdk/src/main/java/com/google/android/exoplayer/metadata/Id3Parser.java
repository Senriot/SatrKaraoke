            ...
            throws UnsupportedEncodingException, ParserException
    {
        ...
        while (id3Size > 0)
        {
            ...
            else if (frameId0 == 'P' && frameId1 == 'R' && frameId2 == 'I' && frameId3 == 'V')
            {
                ...
                System.arraycopy(frame,
                                 firstZeroIndex + 1,
                                 privateData,
                                 0,
                                 frameSize - firstZeroIndex - 1);
            ...
            else if (frameId0 == 'G' && frameId1 == 'E' && frameId2 == 'O' && frameId3 == 'B')
            {
                ...
                String description = new String(frame,
                                                descriptionStartIndex,
                                                descriptionEndIndex - descriptionStartIndex,
                                                charset);
                ...
                System.arraycopy(frame,
                                 descriptionEndIndex + delimiterLength(encoding),
                                 objectData,
                                 0,
                                 objectDataSize);
            ...
            {
                String type = String.format(Locale.US,
                                            "%c%c%c%c",
                                            frameId0,
                                            frameId1,
                                            frameId2,
