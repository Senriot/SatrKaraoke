...
public class SmoothStreamingManifest
{
     ...
     */
    public SmoothStreamingManifest(int majorVersion,
                                   int minorVersion,
                                   long timescale,
                                   long duration,
    ...
    public static class TrackElement implements FormatWrapper
    {
        ...
        {
            this.csd = csd;
            format = new Format(String.valueOf(index),
                                mimeType,
                                maxWidth,
                                maxHeight,
                                -1,
    ...
    public static class StreamElement
    {
        ...
        public Uri buildRequestUri(int track, int chunkIndex)
        {
            ...
            String chunkUrl = chunkTemplate
                    .replace(URL_PLACEHOLDER_BITRATE,
                             Integer.toString(tracks[track].format.bitrate))
                    .replace(URL_PLACEHOLDER_START_TIME,
                             chunkStartTimes.get(chunkIndex).toString());
