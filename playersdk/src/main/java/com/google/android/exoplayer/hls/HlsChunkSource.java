...
public class HlsChunkSource
{
                                   ...
                                   long playbackPositionUs)
    {
        ...
        Uri chunkUri = UriUtil.resolveToUri(mediaPlaylist.baseUri,
                                            segment.url);
        ...
        if (segment.isEncrypted)
        {
            ...
            if (!keyUri.equals(encryptionKeyUri))
            {
                ...
                Chunk toReturn = newEncryptionKeyChunk(keyUri,
    ...
    private MediaPlaylistChunk newMediaPlaylistChunk(int variantIndex)
    {
        ...
        return new MediaPlaylistChunk(dataSource,
                                      dataSpec,
                                      scratchSpace,
                                      playlistParser,
                                      variantIndex,
    ...
    {
        DataSpec dataSpec = new DataSpec(keyUri,
                                         0,
                                         C.LENGTH_UNBOUNDED,
                                         null,
                                         DataSpec.FLAG_ALLOW_GZIP);
    ...
    private static class MediaPlaylistChunk extends DataChunk
    {
        ...
        public MediaPlaylistChunk(DataSource dataSource,
                                  DataSpec dataSpec,
                                  byte[] scratchSpace,
