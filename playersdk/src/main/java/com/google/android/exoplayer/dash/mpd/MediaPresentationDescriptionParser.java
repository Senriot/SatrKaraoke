        ...
        implements UriLoadable.Parser<MediaPresentationDescription>
{
                                                                             ...
                                                                             String baseUrl) throws XmlPullParserException, IOException, ParseException
    {
        ...
        long minUpdateTimeMs = (dynamic) ? parseDuration(xpp,
                                                         "minimumUpdatePeriod",
                                                         -1) : -1;
        ...
        return buildMediaPresentationDescription(availabilityStartTime,
                                                 durationMs,
                                                 minBufferTimeMs,
                                                 dynamic,
                                                 minUpdateTimeMs,
    ...
    {
        return new MediaPresentationDescription(availabilityStartTime,
                                                durationMs,
                                                minBufferTimeMs,
                                                dynamic,
                                                minUpdateTimeMs,
    ...
    protected AdaptationSet parseAdaptationSet(XmlPullParser xpp,
                                               String baseUrl,
                                               long periodStartMs,
                                               ...
                                               SegmentBase segmentBase) throws XmlPullParserException, IOException
    {
        ...
        do
        {
            ...
            {
                segmentBase = parseSegmentList(xpp,
                                               baseUrl,
        ...
        return buildAdaptationSet(id,
                                  contentType,
                                  representations,
                                  contentProtectionsBuilder.build());
    }
    ...
    protected Representation parseRepresentation(XmlPullParser xpp,
                                                 String baseUrl,
                                                 long periodStartMs,
                                                 long periodDurationMs,
            ...
            throws XmlPullParserException, IOException
    {
        ...
        int audioSamplingRate = parseInt(xpp,
                                         "audioSamplingRate",
    ...
    protected Format buildFormat(String id,
                                 String mimeType,
                                 int width,
                                 int height,
                                 float frameRate,
    ...
    protected Representation buildRepresentation(long periodStartMs,
                                                 long periodDurationMs,
                                                 String contentId,
                                                 int revisionId,
                                                 Format format,
    ...
    protected SingleSegmentBase buildSingleSegmentBase(RangedUri initialization,
                                                       long timescale,
    ...
    protected SegmentList buildSegmentList(RangedUri initialization,
                                           long timescale,
                                           long presentationTimeOffset,
                                           long periodDurationMs,
                                           int startNumber,
    ...
    protected SegmentTemplate parseSegmentTemplate(XmlPullParser xpp,
                                                   String baseUrl,
                                                   ...
                                                   long periodDurationMs) throws XmlPullParserException, IOException
    {
        ...
        return buildSegmentTemplate(initialization,
                                    timescale,
    ...
    protected SegmentTemplate buildSegmentTemplate(RangedUri initialization,
                                                   long timescale,
                                                   long presentationTimeOffset,
                                                   long periodDurationMs,
                                                   int startNumber,
                                                   ...
                                                   String baseUrl)
    {
        return new SegmentTemplate(initialization,
                                   timescale,
                                   presentationTimeOffset,
                                   periodDurationMs,
                                   startNumber,
    ...
    protected static final class ContentProtectionsBuilder implements Comparator<ContentProtection>
    {
        ...
        public void endRepresentation()
        {
            ...
            else
            {
                ...
                {
                    Collections.sort(currentRepresentationProtections, this);
                    Assertions.checkState(currentRepresentationProtections.equals(
        ...
        public ArrayList<ContentProtection> build()
        {
            ...
            else
            {
                ...
                {
                    maybeAddContentProtection(adaptationSetProtections,
