...
public final class HlsPlaylistParser implements UriLoadable.Parser<HlsPlaylist>
{
        ...
        while (iterator.hasNext())
        {
            ...
            if (line.startsWith(MEDIA_TAG))
            {
                ...
                if (SUBTITLES_TYPE.equals(type))
                {
                    ...
                    String language = HlsParserUtil.parseOptionalStringAttr(line,
                                                                            LANGUAGE_ATTR_REGEX);
                    boolean isDefault = HlsParserUtil.parseOptionalBooleanAttr(line,
                                                                               DEFAULT_ATTR_REGEX);
                    boolean autoSelect = HlsParserUtil.parseOptionalBooleanAttr(line,
            ...
            throws IOException
    {
        ...
        while (iterator.hasNext())
        {
            ...
            {
                mediaSequence = HlsParserUtil.parseIntAttr(line,
            ...
            else if (line.startsWith(KEY_TAG))
            {
                ...
                if (isEncrypted)
                {
                    encryptionKeyUri = HlsParserUtil.parseStringAttr(line,
                                                                     URI_ATTR_REGEX,
                                                                     URI_ATTR);
            ...
            {
                String byteRange = HlsParserUtil.parseStringAttr(line,
                                                                 BYTERANGE_REGEX,
                                                                 BYTERANGE_TAG);
