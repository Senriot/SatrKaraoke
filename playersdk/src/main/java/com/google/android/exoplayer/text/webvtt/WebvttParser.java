...
public final class WebvttParser implements SubtitleParser
{
    ...
    private static final Pattern WEBVTT_CUE_SETTING        = Pattern.compile(
            ...
            throws IOException
    {
        ...
        BufferedReader webvttData = new BufferedReader(new InputStreamReader(inputStream,
                                                                             C.UTF8_NAME));
        String line;
        ...
        while ((line = webvttData.readLine()) != null)
        {
            ...
            WebvttCue cue = new WebvttCue(startTime,
                                          endTime,
                                          text,
                                          lineNum,
                                          position,
