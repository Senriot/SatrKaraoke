                                                   ...
                                                   SmoothStreamingTrackSelector.Output
{
                                       ...
                                       long liveEdgeLatencyMs)
    {
        ...
        if (protectionElement != null)
        {
            ...
            trackEncryptionBoxes[0] = new TrackEncryptionBox(true,
    ...
    public void continueBuffering(long playbackPositionUs)
    {
        ...
        if (currentManifest != newManifest && newManifest != null)
        {
            ...
            {
                long currentElementEndTimeUs = currentElement.getStartTimeUs(
                        currentElementChunkCount - 1)
                                        ...
                                        long playbackPositionUs, ChunkOperationHolder out)
    {
        ...
        if (enabledTrack.isAdaptive())
        {
            adaptiveFormatEvaluator.evaluate(queue,
                                             playbackPositionUs,
                                             enabledTrack.adaptiveFormats,
                                             evaluation);
        }
        else
        {
        ...
        Chunk mediaChunk = newMediaChunk(selectedFormat,
                                         uri,
                                         null,
                                          ...
                                          int trackIndex)
    {
        ...
        switch (element.type)
        {
            case StreamElement.TYPE_VIDEO:
                mediaFormat = MediaFormat.createVideoFormat(format.mimeType,
                                                            format.bitrate,
            ...
            case StreamElement.TYPE_AUDIO:
                ...
                mediaFormat = MediaFormat.createAudioFormat(format.mimeType,
                                                            format.bitrate,
                                                            MediaFormat.NO_VALUE,
                                                            durationUs,
            ...
            case StreamElement.TYPE_TEXT:
                mediaFormat = MediaFormat.createTextFormat(format.mimeType,
                                                           format.bitrate,
                                                           format.language,
                                                           durationUs);
        ...
        Track mp4Track = new Track(trackIndex,
                                   mp4TrackType,
                                   element.timescale,
                                   durationUs,
                                   mediaFormat,
    ...
    private static MediaChunk newMediaChunk(Format formatInfo,
                                            Uri uri,
                                            String cacheKey,
