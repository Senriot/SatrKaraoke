...
public class SmoothStreamingManifestParser implements UriLoadable.Parser<SmoothStreamingManifest>
{
    ...
    private static abstract class ElementParser
    {
                ...
                switch (eventType)
                {
                    case XmlPullParser.START_TAG:
                        ...
                        else if (foundStartTag)
                        {
                            ...
                            {
                                ElementParser childElementParser = newChildParser(this,
                                                                                  tagName,
                                                                                  baseUri);
        ...
        protected final int parseRequiredInt(XmlPullParser parser,
                                             String key) throws ParserException
        {
            String value = parser.getAttributeValue(null, key);
            if (value != null)
            {
    ...
    private static class SmoothStreamMediaParser extends ElementParser
    {
        ...
        public Object build()
        {
            ...
            return new SmoothStreamingManifest(majorVersion,
                                               minorVersion,
                                               timescale,
                                               duration,
                                               dvrWindowLength,
    ...
    private static class StreamElementParser extends ElementParser
    {
        ...
        public Object build()
        {
            ...
            return new StreamElement(baseUri,
                                     url,
                                     type,
                                     subType,
                                     timescale,
