...
public final class MediaCodecUtil
{
            ...
            if (isCodecUsableDecoder(info, codecName, secureDecodersExplicit))
            {
                ...
                for (int j = 0; j < supportedTypes.length; j++)
                {
                    ...
                    if (supportedType.equalsIgnoreCase(mimeType))
                    {
                        ...
                        boolean secure = mediaCodecList.isSecurePlaybackSupported(key.mimeType,
                                                                                  capabilities);
     ...
     */
    @TargetApi(21)
    public static boolean isSizeAndRateSupportedV21(String mimeType,
                                                    boolean secure,
                                                    int width,
                                                    int height,
                                                    double frameRate) throws DecoderQueryException
    {
