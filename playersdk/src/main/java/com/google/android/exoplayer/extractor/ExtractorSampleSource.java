 ...
 */
public final class ExtractorSampleSource implements SampleSource,
                                                    SampleSourceReader,
                                                    ExtractorOutput,
                                                    Loader.Callback
{
     ...
     *                              priority. If omitted, the default extractors will be used.
     */
    public ExtractorSampleSource(Uri uri,
                                 ...
                                 Extractor... extractors)
    {
        ...
        if (extractors == null || extractors.length == 0)
        {
            ...
            for (int i = 0; i < extractors.length; i++)
            {
                ...
                {
                    throw new IllegalStateException("Unexpected error creating default extractor",
                                                    e);
                }
    ...
    {
        return new ExtractingLoadable(uri,
                                      dataSource,
                                      extractorHolder,
                                      allocator,
                                      requestedBufferSize,
