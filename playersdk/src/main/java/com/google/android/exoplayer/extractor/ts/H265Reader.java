...
/* package */ final class H265Reader extends ElementaryStreamReader
{
    ...
    private void nalUnitEnd(long position, int offset, int discardPadding, long pesTimeUs)
    {
        ...
        {
            int unescapedLength = NalUnitUtil.unescapeStream(prefixSei.nalData,
                                                             prefixSei.nalLength);
        ...
        {
            int unescapedLength = NalUnitUtil.unescapeStream(suffixSei.nalData,
                                                             suffixSei.nalLength);
                                  ...
                                  NalUnitTargetBuffer pps)
    {
        ...
        output.format(MediaFormat.createVideoFormat(MimeTypes.VIDEO_H265,
