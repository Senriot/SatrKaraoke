...
public class StreamingDrmSessionManager implements DrmSessionManager
{
    ...
    {
        return new StreamingDrmSessionManager(WIDEVINE_UUID,
                                              playbackLooper,
                                              callback,
                                                                  ...
                                                                  EventListener eventListener) throws UnsupportedDrmException
    {
        ...
        return new StreamingDrmSessionManager(PLAYREADY_UUID,
                                              playbackLooper,
                                              callback,
                                              optionalKeyRequestParameters,
                                              eventHandler,
     ...
     * @throws UnsupportedDrmException If the specified DRM scheme is not supported.
     */
    public StreamingDrmSessionManager(UUID uuid,
    ...
    private void postKeyRequest()
    {
        ...
        try
        {
            keyRequest = mediaDrm.getKeyRequest(sessionId,
                                                schemeData,
                                                mimeType,
    ...
    private class PostRequestHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            try
            {
                ...
                {
                    case MSG_PROVISION:
                        response = callback.executeProvisionRequest(uuid,
                                                                    (ProvisionRequest) msg.obj);
                        break;
                    case MSG_KEYS:
