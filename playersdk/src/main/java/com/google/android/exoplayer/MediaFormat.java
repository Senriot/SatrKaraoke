...
public final class MediaFormat
{
    ...
    public static MediaFormat createVideoFormat(String mimeType,
                                                ...
                                                List<byte[]> initializationData)
    {
        return new MediaFormat(mimeType,
                               bitrate,
                               maxInputSize,
                               durationUs,
                               width,
    ...
    /* package */ MediaFormat(String mimeType,
                              int bitrate,
                              int maxInputSize,
                              long durationUs,
                              int width,
  ...
  /* package */ final void setFrameworkFormatV16(android.media.MediaFormat format)
    ...
    private boolean equalsInternal(MediaFormat other, boolean ignoreMaxDimensions)
    {
        if (adaptive != other.adaptive || bitrate != other.bitrate || maxInputSize != other.maxInputSize
                ...
                || !Util.areEqual(language, other.language) || !Util.areEqual(mimeType,
                                                                              other.mimeType)
