...
public abstract class Representation implements FormatWrapper
{
     ...
     */
    public static Representation newInstance(long periodStartMs,
                                             ...
                                             SegmentBase segmentBase)
    {
        ...
        {
            return new SingleSegmentRepresentation(periodStartMs,
                                                   periodDurationMs,
                                                   contentId,
                                                   revisionId,
                                                   format,
        ...
        {
            return new MultiSegmentRepresentation(periodStartMs,
                                                  periodDurationMs,
                                                  contentId,
                                                  revisionId,
                                                  format,
    ...
    public static class SingleSegmentRepresentation extends Representation
    {
         ...
         */
        public static SingleSegmentRepresentation newInstance(long periodStartMs,
                                                              long periodDurationMs,
                                                              String contentId,
                                                              long revisionId,
                                                              Format format,
         ...
         * @param contentLength    The content length, or -1 if unknown.
         */
        public SingleSegmentRepresentation(long periodStartMs,
                                           long periodDurationMs,
                                           String contentId,
                                           long revisionId,
                                           Format format,
            ...
            implements DashSegmentIndex
    {
         ...
         * @param segmentBase      The segment base underlying the representation.
         */
        public MultiSegmentRepresentation(long periodStartMs,
                                          long periodDurationMs,
                                          String contentId,
                                          long revisionId,
                                          Format format,
